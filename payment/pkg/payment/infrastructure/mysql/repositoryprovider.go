...
func (r *repositoryProvider) AccountBalanceRepository(ctx context.Context) model.CustomerBalanceRepository {
	return repository.NewBalanceRepository(ctx, r.client)
}
